#!/bin/bash
#SBATCH --job-name=cut_train_validate_MIST_512
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH -p ampere_gpu
#SBATCH --gres=gpu:1
#SBATCH -o /data/antwerpen/212/vsc21212/projects/cut/logs/train_validate_MIST_512.%j.out
#SBATCH -e /data/antwerpen/212/vsc21212/projects/cut/logs/train_validate_MIST_512.%j.err

# train_validate_MIST.sh
# Runs 5 epochs of CUT training on MIST-HER2 as a cluster confirmation gate.
...
#        find $VSC_DATA/projects/cut/outputs/checkpoints/MIST_smoke_512_e5 -name "*.pth"
#   4. GPU log CSV has entries:
#        cat $VSC_DATA/projects/cut/logs/gpu_train_validate_MIST_512.csv | tail -5
...
nvidia-smi --query-gpu=timestamp,utilization.gpu,memory.used,memory.total \
           --format=csv -l 5 \
    > "$VSC_DATA/projects/cut/logs/gpu_train_validate_MIST_512.csv" & GPU_LOG_PID=$!
...
echo ""
echo "=== GPU log tail ==="
tail -3 "$VSC_DATA/projects/cut/logs/gpu_train_validate_MIST_512.csv"
