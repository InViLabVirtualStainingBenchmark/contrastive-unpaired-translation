...
#   $VSC_DATA/projects/cut/outputs/results/MIST-HER2_full_e400/test_latest/images/fake_B/
#
# Verify after job:
#   find $VSC_DATA/projects/cut/outputs/results/MIST-HER2_full_e400 -name "*.png" | wc -l
