#!/bin/bash
#SBATCH --job-name=cut_eval_BCI_512
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH -p ampere_gpu
#SBATCH --gres=gpu:1
#SBATCH -o /data/antwerpen/212/vsc21212/projects/cut/logs/eval_BCI_512.%j.out
#SBATCH -e /data/antwerpen/212/vsc21212/projects/cut/logs/eval_BCI_512.%j.err
...
#
# Submit ONLY after infer_BCI_full_e100.sh has completed successfully.
